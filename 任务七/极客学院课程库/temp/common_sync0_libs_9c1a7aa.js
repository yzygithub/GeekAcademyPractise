!function (root) {
  function loadJs(e, t) {
    var n = d.createElement("script"), a = !1, r = function () {
      a || (a = !0, t && t())
    };
  ...
  var d = document, head = d.getElementsByTagName("head")[0], browser = function () {
    var e = navigator.userAgent.toLowerCase(), t = /(webkit)[ \/]([\w.]+)/.exec(e) || /(opera)(?:.*version)?[ \/]([\w.]+)/.exec(e) || /(msie) ([\w.]+)/.exec(e) || !/compatible/.test(e) && /(mozilla)(?:.*? rv:([\w.]+))?/.exec(e) || [];
    return t[1]
  }(), Util = {
    loadJs: loadJs,
    loadCss: loadCss,
  ...
  var t = e.BigPipeUtil, n = e.BigPipeEvent, a = function () {
    function e(e, n) {
      var a = function () {
        ...
        var a, r, i, o, c, s = [];
        if (e.styles && e.styles.length)for (a = 0, r = e.styles.length; r > a; a++)o = t.appendStyle(e.styles[a]), s.push(o);
        ...
        var a = i.getNeedLoad(e.js) || [], r = a && a.length, o = function () {
          var a, r;
    ...
    return {
      onPageletArrive: function (t) {
        ...
        var r = e(t, function () {
          var e;
          if (!--n)for (; e = o.shift();)a.trigger("pageletinsert", r, t), e.loadJs(function () {
            a.trigger("pageletdone", r, t)
          })
        });
        o.push(r), n++, r.loadCss()
      }, load: function (e) {
        var n, i, o, c, s, l, d, u, p, f = [], g = location.href;
        for (e instanceof Array ? n = {pagelets: e} : (n = "string" == typeof e ? {pagelets: e} : e, e = n.pagelets || n.pagelet, "string" == typeof e && (e = e.split(/\s*,\s*/))), s = e.length, i = s - 1; i >= 0; i--)o = e[i], f.push("pagelets[]=" + o), p = n.container && n.container[o] || n.container, p && a.once("pageletarrive", function (e) {
          e.container = p
        });
    ...
    function t(e) {
      var t = [];
      if ("string" == typeof e) t = [e]; else if ("[object Array]" === Object.prototype.toString.call(e))for (var r = 0; r < e.length; r++)n[e[r]] !== a && t.push(e[r]);
...
!function (r) {
  function e(r, e) {
    var u = a[r] || (a[r] = []);
    u.push(e);
    var o = n[r] || {}, p = o.pkg ? i[o.pkg].url : o.url || r;
    if (!(p in f)) {
      f[p] = !0;
...
!function (e) {
  var t = 0, n = {
    init: function () {
      ...
      var i = e(window).height(), a = e(window).width(), s = 0, r = 1, l = {
        width: 100,
        height: 100,
        zIndex: 9999,
        poparent: "body",
      ...
      function o() {
        var n = e(i.oneEle).size(), o = n * i.oneWidth, a = o / i.boxWidth;
        a % i.boxWidth > 0;
        var s = e(i.oneEle).parent();
        if (1 == i.loop) {
          e(i.oneEle).parent().width(o).css("left", -i.oneWidth);
          var s = e(i.oneEle).parent(), r = e(i.oneEle).last();
        ...
        e(i.prev).click(function () {
          ...
          } else t > 0 && (t--, TweenMax.to(s, 1, {left: -i.boxWidth * t, ease: Quart.easeOut}))
        }), e(i.next).click(function () {
          1 == i.loop ? TweenMax.to(s, .4, {
            left: -i.oneWidth, onComplete: function () {
              s.css("left", "0px");
              var t = e(i.oneEle).slice(0, 1);
              s.append(t.clone()), e(i.oneEle).slice(0, 1).remove(), console.log("ok")
            }, ease: Quart.easeOut
          }) : a - 1 > t && (t++, TweenMax.to(s, 1, {left: -i.boxWidth * t, ease: Quart.easeOut}))
        })
      }
...
JKXY = {
  init: function () {
    ...
    var e = $(this).find(".cricle"), t = $(this).attr("deg");
    if (1 != $(this).attr("stop")) {
      var e = $(this).find(".cricle"), t = $(this).attr("deg");
    ...
    var a = $(this).children(".lesson-infor"), s = $(this).find(".learn-number"), r = $(this).find(".zhongji");
    s.show(), r.show(), a.addClass("lesson-hover"), $(this).find(".lessonicon-box").css("bottom", "-2px"), TweenMax.to(a, .6, {
      height: 175,
      ease: Quart.easeOut
    });
    var l = a.find("p");
    ...
    var a = t.children(".lesson-infor"), s = t.find(".learn-number"), r = t.find(".zhongji");
    s.hide(), r.hide(), a.removeClass("lesson-hover"), t.find(".lessonicon-box").css("bottom", "4px"), TweenMax.to(a, .6, {
      height: 88,
      ease: Quart.easeNone
    });
    var l = a.find("p");
    ...
    $("input[name='q']").bind("focus", function () {
      $(".search-btn").addClass("search-btn2"), $(".hot-words").hide(), $(this).css({paddingRight: "55px"})
    ...
    }), $(".pewm2").off(), $(".pewm3").off(), $(".pewm2").on("mouseenter", function () {
    }).on("mouseleave", function () {
    }), $(".pewm3").on("mouseenter", function () {
    }).on("mouseleave", function () {
    }), $("#pewm").on("click", function () {
      $(this).fadeOut(), $.cookie("pewm", "none", {expires: 1, path: "/"}), $(".erwma").fadeIn()
  ...
  var t = t ? t : "亲爱的VIP，这是来自极客学院小雪的 Hello~", i = "warning", n = parseInt(n) ? parseInt(n) : 1500;
  switch (e) {
    case 1:
  ...
  var r = $("#" + i).width() / 2;
  $("#" + i).css("marginLeft", -r), $("#" + i).animate({top: "0px", opacity: 1}, 300, function () {
    $("#" + i).delay(n).animate({top: "-50px", opacity: 0}, 500, function () {
...
C.prototype = {
  ...
  var t = t ? t : "亲爱的VIP，这是来自极客学院小雪的 Hello~", i = "warning", n = parseInt(n) ? parseInt(n) : 2e3;
  switch (e) {
    case 1:
      var a = "waring-success";
      break;
...
var protocol = "https:" == document.location.protocol ? "https://" : "http://", EVENTDOMAIN = {
  domain: function (e) {
    var t = RegExp(protocol + "([^/]+)/", "i"), n = e.match(t);
...
}, split = document.location.host.split("."), _length1 = split.length - 1, _length2 = split.length - 2, EVENT_HOST_PRE = "." + split[_length2] + "." + split[_length1];
...
;var shoucang = {
  init: function () {
    this.bindEle()
  }, lock: "true", isShoucang: !0, bindEle: function () {
    ...
    shoucang.lock = !1;
    var n = $(this), o = n.parents("li").attr("id");
    ...
    $.ajax({
      type: "get", url: "/course/fav", success: function (c) {
        JKXY.msgBox(1, c.msg, 1500, function () {
          shoucang.isShoucang = !0
        }), "remove" == o && $("#" + n).remove()
      }, data: {course_id: n}, complete: function () {
      }, dataType: "json"
    })
  }, lessonHover: function () {
    $(this).find(".jd-line").hide()
