(window._gsQueue || (window._gsQueue = [])).push(function () {
  ...
  window._gsDefine("TweenMax", ["core.Animation", "core.SimpleTimeline", "TweenLite"], function (t, e, i) {
    ...
    var l, _, u, p, c, f, m = /(?:\d|\-\d|\.\d|\-\.\d)+/g, d = /(?:\d|\-\d|\.\d|\-\.\d|\+=\d|\-=\d|\+=.\d|\-=\.\d)+/g, g = /(?:\+=|\-=|\-|\b)[\d\-\.]+[a-zA-Z0-9]*(?:%|\b)/gi, v = /[^\d\-\.]/g, y = /(?:\d|\-|\+|=|#|\.)*/g, T = /opacity *= *([^)]*)/, w = /opacity:([^;]*)/, x = /alpha\(opacity *=.+?\)/i, b = /^(rgb|hsl)/, P = /([A-Z])/g, S = /-([a-z])/gi, R = /(^(?:url\(\"|url\())|(?:(\"\))$|\)$)/gi, k = function (t, e) {
      return e.toUpperCase()
    }, A = /(?:Left|Right|Width)/i, C = /(M11|M12|M21|M22)=[\d\-\.e]+/gi, O = /progid\:DXImageTransform\.Microsoft\.Matrix\(.+?\)/i, D = /,(?=[^\)]*(?:\(|$))/gi, M = Math.PI / 180, X = 180 / Math.PI, I = {}, N = document, F = N.createElement("div"), L = N.createElement("img"), E = a._internals = {_specialProps: o}, z = navigator.userAgent, Y = function () {
    ...
    var ve = "scaleX,scaleY,scaleZ,x,y,z,skewX,rotation,rotationX,rotationY,perspective".split(","), ye = q("transform"), Te = B + "transform", we = q("transformOrigin"), xe = null !== q("perspective"), be = function (t, e, i, s) {
      if (t._gsTransform && i && !s)return t._gsTransform;
      var r, n, o, h, l, _, u, p, c, f, m, d, g, v = i ? t._gsTransform || {skewY: 0} : {skewY: 0}, y = 0 > v.scaleX, T = 2e-5, w = 1e5, x = 179.99, b = x * M, P = xe ? parseFloat(Z(t, we, e, !1, "0 0 0").split(" ")[2]) || v.zOrigin || 0 : 0;
      ...
      if (16 === n.length) {
        var S = n[8], R = n[9], k = n[10], A = n[12], O = n[13], D = n[14];
        if (v.zOrigin && (D = -v.zOrigin, A = S * D - n[12], O = R * D - n[13], D = k * D + v.zOrigin - n[14]), !i || s || null == v.rotationX) {
          var I, N, F, L, E, z, Y, U = n[0], j = n[1], B = n[2], V = n[3], q = n[4], W = n[5], $ = n[6], G = n[7], Q = n[11], H = Math.atan2($, k), K = -b > H || H > b;
      ...
      var t, e, i, s, r, n, a, o, h, l, _, u, c, f, m, d, g, v, y, T, w, x, b, P = this.data, S = this.t.style, R = P.rotation * M, k = P.scaleX, A = P.scaleY, C = P.scaleZ, O = P.perspective;
      if (p) {
        var D = 1e-4;
        D > k && k > -D && (k = C = 2e-5), D > A && A > -D && (A = C = 2e-5), !O || P.z || P.rotationX || P.rotationY || (O = 0)
      }
      if (R || P.skewX) v = Math.cos(R), y = Math.sin(R), t = v, r = y, P.skewX && (R -= P.skewX * M, v = Math.cos(R), y = Math.sin(R)), e = -y, n = v; else {
    ...
    var ke = function (t) {
      var e, i = this.t, s = i.filter || Z(this.data, "filter"), r = 0 | this.s + this.c * t;
    ...
    de("opacity,alpha,autoAlpha", {
      defaultValue: "1", parser: function (t, e, i, s, n, a) {
        var o = parseFloat(Z(t, "opacity", r, !1, "1")), h = t.style, l = "autoAlpha" === i;
  ...
  if (!e.TweenLite) {
    ...
    var X = O._internals = {
      isArray: p,
      isSelector: D
    }, I = O._plugins = {}, N = O._tweenLookup = {}, F = 0, L = X.reservedProps = {
      ease: 1,
      delay: 1,
      overwrite: 1,
      onComplete: 1,
      ...
      "true": 1,
      "false": 0
    }, z = k._rootFramesTimeline = new C, Y = k._rootTimeline = new C;
    ...
    r._init = function () {
      ...
      for (n in this.vars) {
        if (_ = this.vars[n], L[n]) _ && (_ instanceof Array || _.push && p(_)) && -1 !== _.join("").indexOf("{self}") && (this.vars[n] = _ = this._swapSelfInParams(_, this)); else if (I[n] && (h = new I[n])._onInitTween(e, this.vars[n], this)) {
          for (this._firstPT = l = {
            _next: this._firstPT,
            t: h,
            p: "setRatio",
      ...
      if (a || n.wake(), t && this._gc) {
        ...
        if (s)for (i = s.length; --i > -1;)this._siblings[i] = U(s[i], this, !0); else this._siblings = U(this.target, this, !0)
      }
