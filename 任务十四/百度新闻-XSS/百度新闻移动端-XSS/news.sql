...
--
-- Host: localhost
-- Generation Time: Jul 02, 2017 at 04:26 PM
...
(15, '互联网', 'node express4', 'img/newsimg/news5.JPEG', '2017-06-09', 'nodetest2'),
(16, '科技', 'node express test', 'img/newsimg/news6.JPEG', '2016-06-11', 'express'),
(20, '推荐', '</td><script>alert(0)</script><td>', '11', '2017-07-01', '11');
...
--
ALTER TABLE `news`
  MODIFY `newsId` int(11) NOT NULL AUTO_INCREMENT COMMENT '自动增长', AUTO_INCREMENT=21;
